      ...
      <div className="max-w-[1500px] mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="text-center mb-24 space-y-6">
           <motion.div
             ...
             className="flex items-center justify-center gap-4 text-[#A67C00]"
           >
           ...
           <h2 className="text-5xl md:text-7xl font-serif font-black text-black tracking-tight relative z-10">
             Legacy & <span className="italic font-light text-[#A67C00]">Storytelling.</span>
           </h2>
        </div>
             ...
             <div className="absolute bottom-12 left-12 right-12 flex flex-col md:flex-row items-end justify-between gap-12">
                <div className="max-w-2xl space-y-6">
                   <div className="flex items-center gap-4">
                      <span className="px-4 py-1.5 rounded-full bg-[#A67C00] text-white text-[9px] font-black uppercase tracking-widest">Featured Narrative</span>
                ...
                <Link 
                  ...
                  className="px-10 py-5 bg-white text-black rounded-full text-[10px] font-black uppercase tracking-[0.3em] flex items-center gap-3 hover:bg-[#A67C00] hover:text-white transition-all transform active:scale-95 whitespace-nowrap"
                >
          ...
          {rest.map((article, i) => (
            ...
            >
              <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-xl bg-white ring-1 ring-black/5">
                ...
                <div className="absolute inset-0 bg-[#A67C00]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-6 text-[9px] font-black uppercase tracking-widest text-[#A67C00]/60">
                ...
                <h4 className="text-2xl font-serif font-black text-black leading-snug group-hover:text-[#A67C00] transition-colors">
                  {article.title}
                </h4>
        ...
        <div className="mt-48 p-16 rounded-[4rem] bg-black text-white relative overflow-hidden flex flex-col items-center text-center space-y-8">
           ...
           <div className="relative z-10 space-y-4 max-w-2xl">
              <span className="text-[10px] font-black tracking-[0.5em] text-[#A67C00] uppercase">Stay Storied</span>
              <h3 className="text-4xl md:text-6xl font-serif font-black">Join the <span className="italic font-light text-[#A67C00]">Sovereign Circle.</span></h3>
           ...
           <div className="relative z-10 w-full max-w-md flex flex-col sm:flex-row gap-4 pt-4">
              <input 
                ...
                className="flex-1 px-8 py-5 rounded-full bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-[#A67C00] transition-colors"
              />
              <button className="px-10 py-5 bg-[#A67C00] text-white rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-black transition-all">
                Subscribe
              </button>
           </div>
        </div>
