...
export default function PackagesClient({ packages }: { packages: TourPackage[] }) {
  ...
  return (
    <div className="min-h-screen selection:bg-[#02210a]/20">
      
      {/* ── Compact & Efficient Header ── */}
      <div className="relative pt-32 pb-12 px-6 md:px-16 lg:px-24 bg-white border-b border-[#02210a]/10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-end justify-between gap-12">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <div className="h-[2px] w-8 bg-[#02210a]" />
              <span className="text-[10px] uppercase tracking-[0.5em] text-[#02210a] font-black">Private Collection</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-serif font-black text-[#1A1A1A] tracking-tight">
              Elite <span className="italic font-light text-[#02210a]">Expeditions.</span>
            </h1>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="relative w-full md:w-64 group">
              <SearchIcon size={14} className="absolute left-4 top-1/2 -translate-y-1/2 text-black/30 group-focus-within:text-[#02210a] transition-colors" />
              <input 
                type="text"
                placeholder="Filter within collection..."
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                className="w-full bg-black/[0.03] border border-black/5 rounded-xl py-2.5 pl-11 pr-4 text-[11px] font-medium focus:outline-none focus:border-[#02210a]/30 focus:bg-white transition-all placeholder:text-black/30"
              />
            </div>
              ...
              {CATEGORIES.map((cat) => (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-[0.2em] transition-all duration-300 border ${
                    active === cat 
                      ? "bg-[#02210a] border-[#02210a] text-white shadow-lg shadow-[#02210a]/20" 
      ...
      <div className="px-6 md:px-16 lg:px-24 pt-16 pb-96 bg-[#F8F5F0]">
        <div className="max-w-7xl mx-auto">
                    ...
                    <div className="relative h-full flex flex-col rounded-[2rem] bg-white shadow-[0_24px_60px_rgba(15,23,42,0.12)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_28px_70px_rgba(15,23,42,0.18)] overflow-visible">
                      ...
                      <div className="relative h-48 overflow-hidden rounded-t-[2rem] bg-slate-100">
                        ...
                        <div className="absolute top-4 left-4 z-10">
                          {pkg.badge && (
                            <span className="inline-flex items-center rounded-full bg-[#02210a] px-3 py-1 text-[9px] font-semibold uppercase tracking-[0.26em] text-white shadow-sm">
                              {pkg.badge}
                            </span>
                          )}
                        </div>
                        <div className="absolute top-4 right-4 z-10 flex items-center gap-2 rounded-full bg-white/90 px-3 py-1 shadow-sm">
                          <Star size={12} className="text-[#02210a]" />
                      ...
                      <div className="p-5 flex-1 flex flex-col">
                        <div className="flex items-start justify-between gap-4 mb-3">
                          ...
                          <span className="text-lg font-black text-[#02210a] whitespace-nowrap">
                        ...
                        <div className="mt-auto border-t border-slate-200 pt-4 relative">
                          ...
                          <div className="absolute -right-4 top-0 h-14 w-14 rounded-full bg-white text-[#1A1A1A] shadow-[0_18px_32px_rgba(15,23,42,0.08)] ring-1 ring-slate-200 flex items-center justify-center transition-all duration-300 group-hover:bg-[#02210a] group-hover:text-white">
          ...
          {filtered.length === 0 && (
            ...
            >
              <Compass size={32} className="mx-auto text-[#02210a]/20 mb-6 animate-pulse" />
