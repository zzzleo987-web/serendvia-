    ...
    <div className="p-8 md:p-12">
      <div className="flex items-center justify-between mb-10">
        ...
        <Link
          ...
          className="px-6 py-3 bg-[#A67C00] hover:bg-[#C9960C] text-white text-[11px] font-bold uppercase tracking-[0.3em] rounded-full transition-all duration-300 shadow-lg shadow-[#A67C00]/20"
        >
          + New Package
        </Link>
      </div>
